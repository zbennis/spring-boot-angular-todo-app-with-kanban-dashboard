...
export class ErrorComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.loginService.isUserLoggedIn()) {
      this.notificationService.triggerNotification(InternNotificationType.ERROR, 'Oops! something went wrong', 'You are going to be directed automatically to the home page in 10s', 5000);
      setTimeout(() => {
      ...
      this.notificationService.triggerNotification(InternNotificationType.ERROR, 'Oops! something went wrong', 'You are going to be directed automatically to the login page in 5s', 5000);
      setTimeout(() => {
